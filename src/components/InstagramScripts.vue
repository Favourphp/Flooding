<template>
    ...
    <button class="btn btn-md btn-success  ml-1 mb-1"
        ...
        <font-awesome-icon icon="robot" class="h-3 w-3 text-md" />
        {{ $t('accountWarmup') }}
    </button>
    <button class="btn btn-md btn-success  ml-1 mb-1"
        @click="$emiter('showDialog', { name: 'beforeRunScriptDialog', script: { name: 'post' } })">
        <font-awesome-icon icon="paper-plane" class="h-3 w-3 text-md" />
        {{ $t('post') }}
    </button>
    <button class="btn btn-md btn-success  ml-1 mb-1"
    ...
    <button class="btn btn-md btn-success  ml-1 mb-1"
        ...
        <font-awesome-icon icon="fa fa-user-plus" class="h-3 w-3 text-md" />
        {{ $t('boostUsers') }}
    </button>
    <button class="btn btn-md btn-success  ml-1 mb-1"
        @click="$emiter('showDialog', { name: 'beforeRunScriptDialog', script: { name: 'boostPosts' } })">
        <font-awesome-icon icon="fa-solid fa-thumbs-up" class="h-3 w-3 text-md" />
        {{ $t('boostPosts') }}
    </button>
    <button class="btn btn-md btn-success ml-1 mb-1"
        @click="$emiter('showDialog', { name: 'beforeRunScriptDialog', script: { name: 'boostLives' } })">
        <font-awesome-icon icon="fa-solid fa-video" class="h-3 w-3 text-md" />
        {{ $t('boostLives') }}
    </button>
    <button class="btn btn-md btn-success  ml-1 mb-1"
