<template>
    ...
    <button class="btn btn-primary btn-success  ml-1 mb-1" @click="grantInstagram">
        <font-awesome-icon icon="fa fa-hand-holding-usd" class="h-3 w-3 text-md" />
        {{ $t('grant Instagram') }}
    </button>
    ...
    <button class="btn btn-md btn-success  ml-1 mb-1"
        ...
        <font-awesome-icon icon="fa fa-play" class="h-3 w-3 text-md" />
        {{ $t('openAppAgent') }}
    </button>
